...
ecommerce.get('/dashboard', authenticateUser, (req, res) => {
...
ecommerce.use(loggerMiddleware);
...
ecommerce.post('/cart/add/:productId', authenticateUser, (req, res) => {
...
ecommerce.get('/products/:id', (req, res) => {
